...
- Reverse Transcription (RT) Protocol: `TBD`
- PCR Protocol: `TBD`
- Library Preparation Protocol: `TBD`

## 1.2 Laboratory Metrics
...
- The full source code of the pipeline can be found in this [repository](https://bitbucket.org/mugqic/genpipes/src/master/)
...
This run was processed using the following refernece genome: **`r reference.genome`**
...
```{r bioinf_metrics}
knitr::opts_chunk$set(echo = FALSE, warning=FALSE)
knitr::kable(bioinf.metrics) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>% 
  scroll_box(width = "100%", height = "800px")

```

This table is also available as a [csv file](report_metrics.csv). Additional metrics can be found in the full processing results. 
